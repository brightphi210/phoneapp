        ...
        <form className='flex justify-center items-center h-screen w-full'>
            <div className='w-full flex flex-col gap-7'>
                ...
                <div className='flex flex-col lg:w-1/3 w-10/12  m-auto '>
                    <p className='text-left lg:text-lg text-sm lg:font-bold font-medium pb-2'>Full Name: </p>
                ...
                <button className='bg-green-600 lg:w-1/3 w-10/12 m-auto p-4 rounded-lg'>Register</button>

                <p className='lg:w-1/3 w-10/12  m-auto'>Already have an account? <Link to={'/'}><span className='text-green-600'>Login</span></Link></p>
